...
public class Config {
    ...
    //Ship config
    public static final double SHIP_WIDTH = 60;
    public static final double SHIP_HEIGHT = 60;
    public static final double HEALTH = 100;
    public static final double SHIP_SPEED = 0.5;
    public static final double ROTATION = 15;

    public static final double SHIP1_ORIGIN = 100;
    public static final double SHIP1_INIT_DIRECTION = 0;
    public static final double SHIP2_ORIGIN = 700;
    public static final double SHIP2_INIT_DIRECTION = 0;
    //Bullet config
